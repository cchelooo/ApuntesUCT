...
\diagrama{../../diagrams/int4/diagrama_arquitectura.png}{Diagrama de arquitectura de software de ApuntesUCT}{ApuntesUCT - Diagrama de Arquitectura de Software.}{fig:arquitectura-software}
...
\diagrama{../../diagrams/int4/diagrama_componentes.png}{Diagrama de componentes UML de ApuntesUCT}{ApuntesUCT - Diagrama de Componentes UML.}{fig:componentes-uml}
...
\diagrama{../../diagrams/int4/diagrama_mer_auth.png}{Diagrama MER del Auth Service}{ApuntesUCT - MER Auth Service.}{fig:mer-auth}
...
\diagrama{../../diagrams/int4/diagrama_mer_catalog.png}{Diagrama MER del Catalog Service}{ApuntesUCT - MER Catalog Service.}{fig:mer-catalog}
...
\diagrama{../../diagrams/int4/diagrama_mer_material.png}{Diagrama MER del Material Service}{ApuntesUCT - MER Material Service.}{fig:mer-material}
...
\diagrama{../../diagrams/int4/diagrama_mer_quality.png}{Diagrama MER del Quality Service}{ApuntesUCT - MER Quality Service.}{fig:mer-quality}
...
\diagrama{../../diagrams/int4/diagrama_mer_search.png}{Diagrama MER del Search Service}{ApuntesUCT - MER Search Service.}{fig:mer-search}
...
\begin{itemize}
    \item Diagrama de componentes UML: \texttt{../../diagrams/int4/diagrama\_componentes.png}.
    \item Diagrama de arquitectura de software: \texttt{../../diagrams/int4/diagrama\_arquitectura.png}.
    \item Diagrama MER Auth Service: \texttt{../../diagrams/int4/diagrama\_mer\_auth.png}.
    \item Diagrama MER Catalog Service: \texttt{../../diagrams/int4/diagrama\_mer\_catalog.png}.
    \item Diagrama MER Material Service: \texttt{../../diagrams/int4/diagrama\_mer\_material.png}.
    \item Diagrama MER Quality Service: \texttt{../../diagrams/int4/diagrama\_mer\_quality.png}.
    \item Diagrama MER Search Service: \texttt{../../diagrams/int4/diagrama\_mer\_search.png}.
\end{itemize}
